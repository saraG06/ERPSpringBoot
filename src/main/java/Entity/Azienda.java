...
public class Azienda {
    ...
    @OneToMany(mappedBy = "azienda",fetch = FetchType.LAZY)
    private List<Colleaboratore> listaCollaboratori = new ArrayList<>();
    ...
    public List<Colleaboratore> getListaCollaboratori() {
        return listaCollaboratori;
    }

    public void setListaCollaboratori(List<Colleaboratore> listaCollaboratori) {
